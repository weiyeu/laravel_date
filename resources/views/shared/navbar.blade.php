...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/laravel_date/public/home"><i class="fa fa-heart"></i> 一起來晚餐吧!</a>
        </div>
        <div class="collapse navbar-collapse" id="homeNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="/laravel_date/public/home"><span class="glyphicon glyphicon-home"></span> 首頁</a></li>
                <li><a href="/laravel_date/public/about"><span class="glyphicon glyphicon-info-sign"></span> 關於</a></li>
                @if(Auth::check())
